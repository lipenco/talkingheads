    ...
    create: function(f) {
      return function() {
        ...
        function p(d) {
          ...
          case r:
            H = "50% 0%";
            s = "rotateX( 30deg ) translateY( -100% ) translateY( " + c.overlap + "px )";
            t = "50% 0";
            I = "translateY( " + c.height + "px ) rotateX( -15deg )";
            u = {
          ...
          case w:
            H = "100% 50%";
            s = "rotateY( 30deg ) translateX( 100% ) translateX( -2px ) scale( 1.01 )";
            t = "100% 50%";
            I = "translateX( -" + c.width + "px ) rotateY( -15deg )";
            u = {
          ...
          case x:
            ...
            break;
          default:
            H = "100% 50%", s = "translateX( -100% ) translateX( " + c.overlap + "px ) scale( 1.01 ) rotateY( -30deg )", t = "0 50%", I = "translateX( " + c.width + "px ) rotateY( 15deg )", u = {
          ...
          b.wrapper.style[a.prefix("perspective")] = "800px";
